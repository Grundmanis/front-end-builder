...
import {Navbar} from "./Layouts/Bootstrap/Navbar";
import {Header} from "./Layouts/Bootstrap/Header";
import {SortableItem} from "./SortableItem";
import {Sidebar} from "./Layouts/Bootstrap/Sidebar";
import {Container} from "./Layouts/Bootstrap/Container";
import {restrictToHorizontalAxis, restrictToParentElement, restrictToVerticalAxis} from "@dnd-kit/modifiers";

var html2json = require('html2json').html2json;
var json2html = require('html2json').json2html;

export const WorkPanel_old = (props: any) => {
